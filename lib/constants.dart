...
const Color Pending = Color(0xFF077E8C);
const Color kSecondaryColor = Color(0xFF1DA1F2);
const Color kTextBlackColor = Color(0xC21B262C);
const Color kTextWhiteColor = Color(0xFFFFFFFF);
const Color kContainerColor = Color(0xFF777777);
const Color kOtherColor = Color(0xFFF4F6F7);
const Color kTextLightColor = Color(0xDB1B262C);
